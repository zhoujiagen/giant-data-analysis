...
import net.opentsdb.tsd.StatsCollectorWorker;
...
final class TSDMain {
  ...
  public static void main(String[] args) throws IOException {
    ...
    argp.addOption("--statswport", "Force all stats to include the port");// MARK 统计端口???
  ...
  private static void registerShutdownCollectorHook() {
