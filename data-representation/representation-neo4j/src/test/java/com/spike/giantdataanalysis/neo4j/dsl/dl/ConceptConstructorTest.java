...
import com.spike.giantdataanalysis.neo4j.dsl.dl.concept.CAggreement;
import com.spike.giantdataanalysis.neo4j.dsl.dl.concept.CAtLeastNumberRestriction;
import com.spike.giantdataanalysis.neo4j.dsl.dl.concept.CAtMostNumberRestriction;
import com.spike.giantdataanalysis.neo4j.dsl.dl.concept.CBottom;
import com.spike.giantdataanalysis.neo4j.dsl.dl.concept.CDisAggreement;
import com.spike.giantdataanalysis.neo4j.dsl.dl.concept.CExactNumberRestriction;
import com.spike.giantdataanalysis.neo4j.dsl.dl.concept.CExistentialQuantification;
import com.spike.giantdataanalysis.neo4j.dsl.dl.concept.CIndividual;
import com.spike.giantdataanalysis.neo4j.dsl.dl.concept.CIntersection;
import com.spike.giantdataanalysis.neo4j.dsl.dl.concept.CLimitedExistentialQuantification;
import com.spike.giantdataanalysis.neo4j.dsl.dl.concept.CNegation;
import com.spike.giantdataanalysis.neo4j.dsl.dl.concept.COneOf;
import com.spike.giantdataanalysis.neo4j.dsl.dl.concept.CQualifiedAtLeastRestriction;
import com.spike.giantdataanalysis.neo4j.dsl.dl.concept.CQualifiedAtMostRestriction;
import com.spike.giantdataanalysis.neo4j.dsl.dl.concept.CQualifiedExactRestriction;
import com.spike.giantdataanalysis.neo4j.dsl.dl.concept.CRoleFiller;
import com.spike.giantdataanalysis.neo4j.dsl.dl.concept.CRoleValueMap;
import com.spike.giantdataanalysis.neo4j.dsl.dl.concept.CSameAs;
import com.spike.giantdataanalysis.neo4j.dsl.dl.concept.CTop;
import com.spike.giantdataanalysis.neo4j.dsl.dl.concept.CUnion;
import com.spike.giantdataanalysis.neo4j.dsl.dl.concept.CValueRestriction;
...
public class ConceptConstructorTest {
  ...
  public void complex_example() {
    ConceptConstructor c = new CUnion(//
        ...
        new CIntersection(//
            new CExistentialQuantification(RoleConstructor.atomic("R3"), ConceptConstructor.atomic("C3")), //
