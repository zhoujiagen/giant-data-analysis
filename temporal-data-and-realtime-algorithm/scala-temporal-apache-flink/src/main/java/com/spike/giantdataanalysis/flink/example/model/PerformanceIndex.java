...
public class PerformanceIndex {
	...
	public static class OperationSystem {
		...
		public static enum Disk {
			...
			df_bytes_free_percent(1, Metrics.MetricType.PERCENT, "df.bytes.free.percent",
					"磁盘可用量占总量的百分比, float64, 比如32.1"), //
		...
		public static enum DiskIO {
			disk_io_ios_in_progress(0, Metrics.MetricType.INT, "disk.io.ios_in_progress",
			...
			disk_io_msec_total(2, Metrics.MetricType.INT, "disk.io.msec_total",
					"Amount of time during which ios_in_progress >= 1."), //
			disk_io_msec_weighted_total(3, Metrics.MetricType.INT, "disk.io.msec_weighted_total",
					"Measure of recent I/O completion time and backlog."), //
			disk_io_msec_write(4, Metrics.MetricType.INT, "disk.io.msec_write",
					"Total number of ms spent by all writes."), //
			disk_io_read_merged(5, Metrics.MetricType.INT, "disk.io.read_merged",
					"Adjacent read requests merged in a single req."), //
			disk_io_read_requests(6, Metrics.MetricType.INT, "disk.io.read_requests",
					"Total number of reads completed successfully."), //
			disk_io_read_sectors(7, Metrics.MetricType.INT, "disk.io.read_sectors",
					"Total number of sectors read successfully."), //
			disk_io_write_merged(8, Metrics.MetricType.INT, "disk.io.write_merged",
					"Adjacent write requests merged in a single req."), //
			disk_io_write_requests(9, Metrics.MetricType.INT, "disk.io.write_requests",
					"total number of writes completed successfully."), //
			disk_io_write_sectors(10, Metrics.MetricType.INT, "disk.io.write_sectors",
		...
		public static enum Kernel {
			...
			kernel_files_allocated(1, Metrics.MetricType.INT, "kernel_files.allocated",
					"读取的/proc/sys/fs/file-nr第一个Field"), //
			kernel_files_left(2, Metrics.MetricType.INT, "kernel_files.left",
					"值=kernel_maxfiles-kernel_files.allocated"), //
